...
(function (window, factory) {
  ...
  function getSize(elem) {
    ...
    if (!elem || (0, _typeof2["default"])(elem) != 'object' || !elem.nodeType) {
      return;
    }
...
(function (window, factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(14), __webpack_require__(2), __webpack_require__(15), __webpack_require__(44)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (EvEmitter, getSize, utils, Item) {
...
(function (window, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
(function (window, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(16)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (matchesSelector) {
  ...
  utils.makeArray = function (obj) {
    ...
    var isArrayLike = (0, _typeof2["default"])(obj) == 'object' && typeof obj.length == 'number';
...
var burger = document.getElementsByClassName('menu-burger')[0];
...
var _swiperBundle = _interopRequireDefault(__webpack_require__(25));
    ...
    992: {
      ...
      pagination: {
        ...
        renderBullet: function A(index, className) {
          return "<div class= ".concat(className, "> <span class=\"number\">").concat(index + 1, "</span> <span class=\"band\"></span></div>");
        }
      }
    }
  }
...
var swiper = new _swiperBundle["default"]('.swiper', slider1);
var swiper1 = new _swiperBundle["default"]('.swiper-second', slider2);
...
var _classCallCheck2 = _interopRequireDefault(__webpack_require__(31));
...
var _wrapNativeSuper2 = _interopRequireDefault(__webpack_require__(34));
...
var _construct2 = _interopRequireDefault(__webpack_require__(13));

var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(8));

var infowindow = document.getElementsByClassName('infowindow');
var maps = [{
  el: 'map3',
  center: [53.54991453057005, 9.992826352556174],
  markers: [[{
    lat: 53.55107098445692,
    lng: 9.984418475552841
  }, infowindow[0]], [{
    lat: 53.54675018271004,
    lng: 9.996503109059239
  }, infowindow[1]], [{
    lat: 53.55103886116458,
    lng: 10.009506931691401
  }, infowindow[2]]]
}, {
  el: 'map2',
  center: [48.77925769348138, 9.19723651789767],
  markers: [[{
    lat: 48.77756149501466,
    lng: 9.192088511123096
  }, infowindow[0]], [{
    lat: 48.78124805736547,
    lng: 9.201228849682034
  }, infowindow[1]], [{
    lat: 48.78069422490568,
    lng: 9.196054577566771
  }, infowindow[2]]]
}, {
  el: 'map',
  center: [50.12657239207596, 8.673101223869292],
  markers: [[{
    lat: 50.12457239207596,
    lng: 8.673101223869292
  }, infowindow[0]]]
}];
...
var _isotope = _interopRequireDefault(__webpack_require__(43));

var elem = document.getElementById('filter');
var iso = new _isotope["default"](elem, {
  itemSelector: '.filter-card',
  layoutMode: 'masonry'
});
var filterbtn = Array.from(document.getElementsByClassName('filter-btn'));
...
var elem1 = document.getElementById('filter2');
var iso1 = new _isotope["default"](elem1, {
  itemSelector: '.filter-card',
  layoutMode: 'masonry'
});
filterbtn.forEach(function (el) {
...
var elem2 = document.getElementById('filter3');
var iso2 = new _isotope["default"](elem2, {
  itemSelector: '.filter-card',
  layoutMode: 'masonry'
});
filterbtn.forEach(function (el) {
...
(function (window, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3), __webpack_require__(2), __webpack_require__(16), __webpack_require__(15), __webpack_require__(45), __webpack_require__(4), __webpack_require__(46), __webpack_require__(48), __webpack_require__(49)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Outlayer, getSize, matchesSelector, utils, Item, LayoutMode) {
...
(function (window, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(14), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if ((typeof module === "undefined" ? "undefined" : (0, _typeof2["default"])(module)) == 'object' && module.exports) {
...
(function (window, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4), __webpack_require__(47)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if ((typeof module === "undefined" ? "undefined" : (0, _typeof2["default"])(module)) == 'object' && module.exports) {
...
(function (window, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3), __webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if ((typeof module === "undefined" ? "undefined" : (0, _typeof2["default"])(module)) == 'object' && module.exports) {
...
var _regenerator = _interopRequireDefault(__webpack_require__(52));

var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(55));
